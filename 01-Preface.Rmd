...
You can email me anytime at kaflepratap@gmail.com during the office hours. I will try my best to respond during the weekend/holidays but I can't gurantee as I have a pretty young family and I try to work less during the weekends.
...
leaflet() %>%
    addTiles() %>%
    setView(lng = -73.597, lat = 40.820, zoom = 22)
```
